...
public:
    ...
    //面が作成可能か
    static  bool Creatable(QList<CObject*> lines);
    virtual void Create(QList<CEdge*> edges);     //作成
...
public slots:
    //線移動コールバック
    virtual void ChangeChildCallback(QList<CObject*> egde);
public:
